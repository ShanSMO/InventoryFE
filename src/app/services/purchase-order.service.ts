...
export class PurchaseOrderService {
  ...
  createUpdatePucahseOrder(requestBody: any): Observable<any> {
    ...
    return this.httpClient.post(environment.API_URL.concat(EndPoints.CREATE_UPDATE_PURCHASE_ORDER), requestBody, this.httpRequest.options)
  ...
  loadAllPucahseOrders(): Observable<any> {
    ...
    return this.httpClient.post(environment.API_URL.concat(EndPoints.LOAD_ALL_PURCHASE_ORDERS), {}, this.httpRequest.options)
      .map((response: Response)  => {
          return response;
        }
      );
